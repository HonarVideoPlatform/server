...
class KalturaCuePointErrors extends KalturaErrors implements kCuePointErrors
{
	...
	const USER_HS_CANNOT_LIST_RELATED_CUE_POINTS = "USER_HS_CANNOT_LIST_RELATED_CUE_POINTS;FILTER;Cue-points should not be listed [@FILTER@] as related-objects with unprivileged user hs";
