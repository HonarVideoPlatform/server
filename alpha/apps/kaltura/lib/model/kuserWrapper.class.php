...
class kuserWrapper extends objectWrapperBase
{
	...
	protected $detailed_fields_ext = array ( "country" , "state" , "city"  , "zip" , "urlList" , "networkHighschool" , "networkCollege" , "views" , "fans" , "entries" , "producedHshows" ) ;
	
	protected $detailed_objs_ext = array ( "hshows" , "entrys" );
	
	protected $objs_cache = array ( "hshows" => "*hshow,id" , "entrys" => "*entry,id" );
	
	
	protected $read_only_fields = array ( "id" , "picturePath" , "icon" , "createdAt" , "views" , "fans" , "entries" , "producedHshows", "loginEnabled" );
