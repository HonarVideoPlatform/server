...
{
	/**
	 * @var array<hSourceFileSyncDescriptor>
	 */
	...
	public function migrateOldSerializedData()
	{
		...
		{
			$srcDescriptor = new hSourceFileSyncDescriptor();
	...
	/**
	 * @param array<hSourceFileSyncDescriptor> $srcFileSyncs
	 */
	...
	public function getSrcFileSyncLocalPath()
	{
		...
		if(!$srcDescriptor)
			return null;
		/* @var $srcDescriptor hSourceFileSyncDescriptor */
