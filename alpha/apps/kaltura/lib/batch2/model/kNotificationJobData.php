...
class kNotificationJobData extends kJobData
{
	...
	const NOTIFICATION_TYPE_HSHOW_ADD = 11;
	const NOTIFICATION_TYPE_HSHOW_UPDATE_INFO = 12;
	const NOTIFICATION_TYPE_HSHOW_DELETE = 13;
	const NOTIFICATION_TYPE_HSHOW_UPDATE_PERMISSIONS = 14;
	const NOTIFICATION_TYPE_HSHOW_RANK = 15;
	const NOTIFICATION_TYPE_HSHOW_BLOCK = 16;
	...
	const NOTIFICATION_OBJECT_TYPE_HSHOW = 2;
	...
	public static $NOTIFICATION_OBJ_TYPE_MAP = array (
		...
		self::NOTIFICATION_TYPE_HSHOW_ADD => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
		self::NOTIFICATION_TYPE_HSHOW_UPDATE_INFO => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
		self::NOTIFICATION_TYPE_HSHOW_UPDATE_PERMISSIONS => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
		self::NOTIFICATION_TYPE_HSHOW_DELETE => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
		self::NOTIFICATION_TYPE_HSHOW_RANK => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
		self::NOTIFICATION_TYPE_HSHOW_BLOCK => self::NOTIFICATION_OBJECT_TYPE_HSHOW,
	...
	public static $NOTIFICATION_TYPE_MAP = array (
		...
		self::NOTIFICATION_TYPE_HSHOW_ADD => "hshow_add" ,
		self::NOTIFICATION_TYPE_HSHOW_UPDATE_INFO => "hshow_update_info" ,
		self::NOTIFICATION_TYPE_HSHOW_UPDATE_PERMISSIONS => "hshow_update_permissions" ,
		self::NOTIFICATION_TYPE_HSHOW_DELETE => "hshow_delete" ,
		self::NOTIFICATION_TYPE_HSHOW_RANK => "hshow_rank" ,
		self::NOTIFICATION_TYPE_HSHOW_BLOCK => "hshow_block" ,
	...
	public static function isHshowNotification  ( $type )
	{
		return ( $type >= self::NOTIFICATION_TYPE_HSHOW_ADD &&   $type <= 	self::NOTIFICATION_TYPE_HSHOW_BLOCK );
	}
