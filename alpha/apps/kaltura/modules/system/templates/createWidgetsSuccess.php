	...
	<table >
		<form method='post'>
			...
			<tr><td><input type="checkbox" name="create" <?php echo  $create ? "checked='checked'" : "" ?>>Create new
				,Number of hshows to search: <input name="limit" id="limit" value="<?php echo  $limit ?>" size="5"></td></tr>
			...
			<tr>
			<tr><td><input type="radio" name="method" value="list" <?php echo  $method == "list" ? "checked='checked'" : "" ?> > hshow_ids 
				<input name="hshow_ids" id="hshow_ids" value="<?php echo  $hshow_ids ?>" size="50"></td></tr>
