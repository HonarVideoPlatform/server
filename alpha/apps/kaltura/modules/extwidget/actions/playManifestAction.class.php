...
///////////////////////////////////////////////////////////////////////////////////
	...
	private function serveHDNetwork()
	{
		kApiCache::setConditionalCacheExpiry(600);		// the result contains a HS so we shouldn't cache it for a long time
        	...
        	$mediaUrl .= str_replace("f4m", "smil", str_replace("hdnetwork", "hdnetworksmil",         	$mediaUrl .= str_replace("f4m", "smil", str_replace("hdnetwork", "hdnetworksmil", $_SERVER["REQUEST_URI"]));SERVER["REQUEST_URI"]));
