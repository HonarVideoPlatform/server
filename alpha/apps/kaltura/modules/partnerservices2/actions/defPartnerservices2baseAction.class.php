...
class defPartnerservices2baseAction extends kalturaAction
{
	...
	protected static $allowedActions = array(
		...
		'updatehshowAction.class.php',
		'updatehshowownerAction.class.php',
