...
abstract class BaseroughcutEntry extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the roughcut_hshow_id field.
	 * @var        string
	 */
	protected $roughcut_hshow_id;
	...
	/**
	 * Get the [roughcut_hshow_id] column value.
	 * 
	 * @return     string
	 */
	public function getRoughcutHshowId()
	{
		return $this->roughcut_hshow_id;
	}
	...
	/**
	 * Set the value of [roughcut_hshow_id] column.
	 * 
	 * @param      string $v new value
	 * @return     roughcutEntry The current object (for fluent API support)
	 */
	public function setRoughcutHshowId($v)
	{
		if(!isset($this->oldColumnsValues[roughcutEntryPeer::ROUGHCUT_HSHOW_ID]))
			$this->oldColumnsValues[roughcutEntryPeer::ROUGHCUT_HSHOW_ID] = $this->roughcut_hshow_id;

		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->roughcut_hshow_id !== $v) {
			$this->roughcut_hshow_id = $v;
			$this->modifiedColumns[] = roughcutEntryPeer::ROUGHCUT_HSHOW_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->roughcut_hshow_id = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->ahshow !== null && $this->roughcut_hshow_id !== $this->ahshow->getId()) {
			$this->ahshow = null;
		}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getRoughcutHshowId();
				break;
			case 4:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getRoughcutHshowId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setRoughcutHshowId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(roughcutEntryPeer::ROUGHCUT_HSHOW_ID)) $criteria->add(roughcutEntryPeer::ROUGHCUT_HSHOW_ID, $this->roughcut_hshow_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRoughcutHshowId($this->roughcut_hshow_id);
	...
	{
		if ($v === null) {
			$this->setRoughcutHshowId(NULL);
		} else {
			$this->setRoughcutHshowId($v->getId());
		}
	...
	{
		if ($this->ahshow === null && (($this->roughcut_hshow_id !== "" && $this->roughcut_hshow_id !== null))) {
			$this->ahshow = hshowPeer::retrieveByPk($this->roughcut_hshow_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->ahshow->addroughcutEntrys($this);
			 */
		}
		return $this->ahshow;
	}
