...
abstract class BasekuserPeer {
	...
	/** the column name for the PRODUCED_HSHOWS field */
	const PRODUCED_HSHOWS = 'kuser.PRODUCED_HSHOWS';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(kuserPeer::PRODUCED_HSHOWS);
