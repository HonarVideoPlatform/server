...
abstract class BasePartnerPeer {
	...
	/** the column name for the HS_MAX_EXPIRY_IN_SECONDS field */
	const HS_MAX_EXPIRY_IN_SECONDS = 'partner.HS_MAX_EXPIRY_IN_SECONDS';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PartnerPeer::HS_MAX_EXPIRY_IN_SECONDS);
