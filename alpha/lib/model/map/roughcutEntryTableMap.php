...
class roughcutEntryTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ROUGHCUT_HSHOW_ID', 'RoughcutHshowId', 'VARCHAR', 'hshow', 'ID', false, 20, null);
    ...
    $this->addRelation('hshow', 'hshow', RelationMap::MANY_TO_ONE, array('roughcut_hshow_id' => 'id', ), null, null);
